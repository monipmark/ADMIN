...
Config.Noclip = {
    ...
    { text = 'fast' , speed = 3},
    { text = 'fast x5' , speed = 5},
    { text = 'fast x7' , speed = 7},
    { text = 'fast x10' , speed = 10},
    { text = 'fast x15' , speed = 15},
    { text = 'fast x20' , speed = 20},
    { text = 'fast x30' , speed = 30},
    { text = 'fast x40' , speed = 40},
    { text = 'fast x50' , speed = 50},
}
-----------------------------------------------------------------
-----------------------------------------------------------------
...
Config.NewWeatherTimer = 15 -- ระยะเวลาในการเปลี่ยนสภาพอากาศ
Config.Blackout = true  --  ตั้งค่าเริ่มต้น เปิด/ปิด ไฟในเมือง
Config.StartWeather = 'EXTRASUNNY' -- สภาพเริ่มต้นเมื่อเปิดเซิฟ
Config.BaseTime = 12.00 -- เวลาเริ่มต้นเมื่อเปิดเซิฟ
-----------------------------------------------------------------
-----------------------------------------------------------------
