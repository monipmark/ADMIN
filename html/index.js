...
$(function() {
    ...
    function a(e) { e ? $("#container1").show() : ($("#container1, #actions, #items, #inputmanager, #bans").hide(), $(".server").fadeOut(), $("#server").show(), i(!0), id = 0) }
    ...
    window.addEventListener("message", function(t) {
        ...
        //     $.each(a, function(a, t) { e = 0 == t.time ? "Permanently" : t.time < 0 ? "Expired" : "for " + t.time + " mins", $("#banlist").append(`<div class = "banitem" data-license=${t.license}><span class="bannedplayer">${t.name}</span><span class="time">${e}</span><span class="reason">${t.reason}</span></div>`) })
            ...
            $.each(e, function(e, a) {
                ...
                let t = new Image;
                t.src = `nui://esx_inventoryhud/html/img/items/${a.name}.png`, t.onerror = function() { $('.inventoryitem[data-itemname="' + a.name + '"] > .img').html('<i class="fas fa-box centered" style="color:#ffffff;font-size:48px;"></i>') }
            }), $("#weaponlist").html("");
            let a = i.weaponlist;
            $.each(a, function(e, a) {
                ...
                let t = new Image;
                t.src = `nui://esx_inventoryhud/html/img/items/${a.name}.png`, t.onerror = function() { $('.inventoryitem[data-weaponname="' + a.name + '"] > .img').html(""), $('.inventoryitem[data-weaponname="' + a.name + '"] > .name').addClass("centered") }
            }), $("#jobs").html("");
            let t = i.joblist,
                n = [];
        ...
        switch (s) {
            ...
            case "addBank":
                ...
                break;
                case "addBlack":
                    t(a = "Give Black money to " + playerData[id].name, e = "100$", n = "number", s);
                    break;   
            case "announce":
                t(a = "Your announcement message", e = "message", n = "text", s);
                break;
                case "speedcar":
                t(a = "ปรับความเร็วรถ", e = "จำนวน km/h", n = "text", s);
                break;
            case "promote":
            ...
            case "setJob":
                ...
                break;
            case "setTime":
                t(a = "เปลี่ยนเวลา <br /> (24 hour time)", e = "12:00", n = "time", s);
                break;
            case "changeWeather":
    ...
    $("#inner").append(""), document.onkeyup = function(e) { if (27 == e.which) return $.post("https://admin/exit", JSON.stringify({})), void a(!1) }, $("#tpwp-button").click(function() { $.post("https://admin/tp-wp") }), $("header").on("mousedown", function(e) {
        var a = $("#container1").addClass("drag").css("cursor", "move");
